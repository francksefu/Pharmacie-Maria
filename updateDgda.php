...
<head>
    ...
    <script defer src="./jsfile/takeDgda.js"></script>
    ...
    <main>
        ...
        <div class="container bg-transparent pt-5">
            <div class=" p-3 mb-5 border border-1 rounded mt-5" id="sa">
                <h2 class="p-2">Modifier papier dgda</h2>
                <hr class="w-auto">
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-7 mt-5 mb-4">
                            <div class="input-group ">
                                ...
                                <input required type="text" id="montant" name="CM" class="form-control" placeholder="entrer nom du papier" aria-label="Amount (to the nearest cdf)">
                      ...
                      <div class="input-group">
                        ...
                        <textarea class="form-control" name="commentaire" id="commentaire" aria-label="With textarea" placeholder="Entrer commentaire ou Description"></textarea>
                      </div>
