        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                ...
                <div class="col-md-3 bg-transparent pt-5">
                    <p class="text-center">
                        <a href="addBonusOuPerte.html" class="btn btn-primary p-2">&plus; Ajoutez bonus ou perte</a>
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="input-group mb-3 w-75">
                        ...
                        <label class="input-group-text" for="inputGroupSelect01">bonus ou pertes</label>
                      </div>
                </div>
                <div class="input-group w-50 col-md-5">
                    <span class="input-group-text">Search: </span>
                    <input type="text" class="form-control" placeholder="Entrer un detail dont vous vous sur un bonus ou une perte">
                </div>
            </div>
        </div>
