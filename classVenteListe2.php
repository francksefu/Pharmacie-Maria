...
function dataVente($operation){
    ...
    $valeur = '';
    $sql= ("SELECT * FROM Ventes2, Produit2, Client, DataPersonnel WHERE (Ventes2.idProduit = Produit2.idProduit) and (Client.idClient = Ventes2.idClient and (DataPersonnel.idDataPersonnel = Ventes2.idPersonnel)) and (Operation = $operation)");
