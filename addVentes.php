                    ...
                    <div class="border border-1 p-4 col-md-4 m-2">
                        ...
                        <div class="border border-1 m-2 col-md-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="float" id="montant"  class="form-control" placeholder="0.00" aria-label="Amount (to the nearest dollar)">
                                <span class="input-group-text">$</span>
                            </div>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text">Reste</span>
                                <input type="flaot" id="reste" class="form-control" placeholder="0.00" aria-label="Amount (to the nearest dollar)">
                                <span class="input-group-text">$</span>
                            </div>
                        </div>
