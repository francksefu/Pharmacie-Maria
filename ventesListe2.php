...
function dataVente(){
    ...
    $sql= ("SELECT * FROM Ventes2, Produit2, Client WHERE (Ventes2.idProduit = Produit2.idProduit) and (Client.idClient = Ventes2.idClient) GROUP BY Operation order by Operation desc");
        ...
        <td >
            <div class="d-flex flex-row justify-content-center">
                ...
                <div class="p-2 bg-primary m-2 text-white rounded-3 montre">
                    <a href="updateVentes2.php" class="text-white">
        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                ...
                <div class="col-md-3 bg-transparent pt-5">
                    ...
                    <?php 
                        if ($user != 'Responsable') {
                            echo '<a href="addVentes.php" class="btn btn-primary p-2">&plus; Add ventes</a>';
                        }
                    ?> 
            ...
            <div class="row">
                ...
                <input type="hidden" value="vente2" id="type" >
            </div>
        </div>
    
        <div class="container-fluid pt-5 bg-transparent">
        <?php
            $reqSql0= ("SELECT * FROM Ventes2, Produit2, Client WHERE (Ventes2.idProduit = Produit2.idProduit) and (Client.idClient = Ventes2.idClient) GROUP BY Operation order by Operation desc limit 500");
            render($reqSql0, $user);
          ?>  
        </div>
