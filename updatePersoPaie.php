    ...
    <main>
        ...
        <div class="container bg-transparent pt-5">
            <div class=" p-3 mb-5 border border-1 rounded mt-5" id="sa">
                <h2 class="p-2">Modifier Fiche de paie</h2>
                <h4>Modifier une paie</h4>
                <hr class="w-auto">
                ...
                <div class="input-group mb-3  mx-auto d-block">
                    ...
                    <div class="row">
                        <div class="input-group col-md-7 mb-3">
                            ...
                            <input required list="dataPersonnel" type="text" id="nom" name="CM" class="form-control" placeholder="entrer nom du personnel" aria-label="Amount (to the nearest cdf)">
                         </div>
                    ...
                    <div class="input-group mb-3 col-md-6">
                      ...
                      <input type="hidden" id="check-datalist" value="updatePersoPaie">
