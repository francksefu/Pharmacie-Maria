...
<body class="bg-light">
    ...
    <main>
        ...
        <?php
            $reqSql0= ("SELECT * FROM Ventes, Produit, Client WHERE (Ventes.idProduit = Produit.idProduit) and (Client.idClient = Ventes.idClient) GROUP BY Operation order by Operation desc limit 500");
            render($reqSql0, $user);
          ?>  
        </div>
