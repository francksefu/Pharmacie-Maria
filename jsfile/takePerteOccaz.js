...
function showHint(str) {
    ...
    xmlhttp.open("GET", "classPerteOccaz.php?q=" + str);
    xmlhttp.send();
    }
  }
...
btn.addEventListener('click', () => {
  ...
  let prend;
  if (typeForm.value == 'update') {
    prend = montant.value+"::"+motif.value+"::"+datesout.value+"::"+idCaisse+"::update";
  } else {
    prend = montant.value+"::"+motif.value+"::"+datesout.value+"::add";
  }
