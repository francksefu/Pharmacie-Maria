        ...
        <div class="container bg-transparent pt-5">
            ...
            <form action="">
                <div class="row">
                    <div class="border border-1 p-4 col-md-4 m-2">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect01">Choisir source</label>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input required type="date" class="form-control" placeholder="date d approvisionnement" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <small>1 approvisionnement en cours ...</small>
                    </div>
                ...
                <div class="input-group mb-3 pt-5 pb-4">
                    ...
                    <input type="float" pattern="[0-9]" class="form-control" placeholder="prix d achat" aria-label="Server">
                ...
                <table class="table border border-1">
                    <thead class="bg-transparent text-secondary">
                      <tr>
                        ...
                        <th>Quantite a approvisionné</th>
