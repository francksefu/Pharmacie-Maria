            ...
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    ...
                    <p class=" text-secondary pt-3">
                        Les approvisionnement vous permettent de controler efficacement les ajouts dans le stock et de surveiller
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="input-group mb-3">
                        ...
                        <label class="input-group-text" for="inputGroupSelect01">derniers approvisionnement</label>
                      </div>
                </div>
                <div class="col-md-5">
                    <div class="input-group">
                        <span class="input-group-text">Search: </span>
                        <input type="text" class="form-control" placeholder="Entrer un detail sur l approvisionnement">
                    </div>
                </div>
