  ...
  <div class="collapse navbar-collapse" id="mynavbar">
    <ul class="navbar-nav me-auto">
      ...
      <li class="nav-item pe-3 dropdown" >
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="product2.php">Listez les produits</a></li>
          <li><a class="dropdown-item" href="addproduct2.php">Ajoutez les produits</a></li>
          <li><a class="dropdown-item" href="ventesListe2.php">Listez les ventes</a></li>
          <li><a class="dropdown-item" href="addVentes2.php">Ajoutez les ventes</a></li>
          <li><a class="dropdown-item" href="approvisionnement2.php">Listez les approvisionnement</a></li>
          <li><a class="dropdown-item" href="addApprovisionnement2.php">Ajoutez les approvisionnements</a></li>
          <li><a class="dropdown-item" href="paiements2.php">Listez les paiements</a></li>
          <li><a class="dropdown-item" href="addPaiements2.php">Ajoutez les paiements</a></li>
        </ul>
      </li>
