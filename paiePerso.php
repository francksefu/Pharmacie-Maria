        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>Fiches des paies vue d ensemble</h2>
                    <p class=" text-secondary pt-3">
                        Cette section vous permet de controler et d avoir une bonne vision sur les paiements des vos employés
                        Tout est lister sur la fiche ci dessous, mais si vous voulez voir les paiements d un personnel particulier
                        Allez dans la section du rapport
                    </p>
                </div>
            ...
            <div class="input-group mt-3 col-md-10 montre-moi">
                ...
                <input type="hidden" value="persoPaie" id="type" >
        </div>
