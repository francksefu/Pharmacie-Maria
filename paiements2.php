        ...
        <td >
            <div class="d-flex flex-row justify-content-center">
                ...
                <div class="p-2 bg-primary m-2 text-white rounded-3 montre">
                    <a href="updatePaiements2.php" class="text-white">
...
<body class="bg-light">
    ...
    <main>
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>Liste des paiements (stock 2)</h2>
            ...
            <div class="row">
                ...
                <input type="hidden" value="paiements2" id="type" >
            </div>
        </div>
        ...
        <?php
        if( $user !== "") {
            $reqSql0= ("SELECT * FROM Paiements2, Ventes2, Client WHERE (Paiements2.Operation = Ventes2.Operation) and (Client.idClient = Ventes2.idClient) GROUP BY idPaiements order by idPaiements desc limit 500");
            render($reqSql0, $user);
        }
          ?>  
        </div>
